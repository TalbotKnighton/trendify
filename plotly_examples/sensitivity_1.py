                    ...
                    [
                        ...
                        dcc.Checklist(
                            ...
                            labelStyle={
                                "display": "block",
                                "marginBottom": "10px",
                            },  # Added marginBottom and changed to block
                        ),
                    ],
                    style={
                        "width": "10%",
...
@app.callback(
    ...
    [Input("df1-columns", "value"), Input("df2-columns", "value")],
...
@app.callback(
    [Output("series-info-panel", "children"), Output("series-info-panel", "style")],
    [
        Input({"type": "legend-item", "index": ALL}, "mouseenter"),
        Input({"type": "legend-item", "index": ALL}, "mouseleave"),
    ],
    [State("series-data", "data"), State("series-info-panel", "style")],
)
...
def toggle_color_picker(
    button_clicks, close_clicks, color_option_clicks, button_ids, current_style
):
    """Show/hide color picker when clicking color buttons."""
    ctx = dash.callback_context
    if not ctx.triggered:
