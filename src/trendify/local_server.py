...
class ProductGetter:
    ...
    def _get_data_products(
        ...
        product_collection: API.DataProductCollection = API.DataProductCollection.collect_from_all_jsons(collection_dir)
...
class TrendifyProductServerLocal:
    ...
    def get_new(cls, products_dir: Path, name: str):
        ...
        app.add_url_rule('/<tag>', '/get_data_products', product_getter._get_data_products)
        app.add_url_rule('/<tag>/', '/get_data_products', product_getter._get_data_products)
        app.add_url_rule('/<tag>/<product_type_name>', '/get_data_products', product_getter._get_data_products)
        app.add_url_rule('/<tag>/<product_type_name>/', '/get_data_products', product_getter._get_data_products)
