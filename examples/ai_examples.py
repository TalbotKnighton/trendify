...
if __name__ == "__main__":
    # Example usage
    input_directory = "example_output"
    output_directory = "tdir"
    
    # Generate your data products first
    # ... your data generation code here ...
    
    # Then run the trendify commands
    print(f"\nProcessing data from {input_directory} to {output_directory}")
    run_trendify_commands(input_directory, output_directory)
    print("\nProcessing complete!")

def main():
    # Create output directory
    output_dir = Path(__file__).parent.joinpath('example_output', 'data')
    ...
    output_dir.joinpath('data_products.json').write_text(collection.model_dump_json())
    
    # Run trendify commands
    run_trendify_commands(
        input_dir=output_dir,
        output_dir=output_dir.with_name('trendify'),
    )
if __name__ == "__main__":
    main()